# 5LSL0 Final Assignment main code for mfcc based model
...
plt.savefig('results/mfcc/model_spectrum_norm_acc.pdf')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'valid'], loc='upper left')
plt.savefig('results/mfcc/model_spectrum_norm_loss.pdf')

# save model
model.save('results/mfcc/model_spectrum_norm.h5')
...
np.savetxt('results/mfcc/probabilities_spectrum_norm.csv', y_pred_proba, delimiter=',')
...
wb.save('results/mfcc/submission_spectrum_norm.xlsx')